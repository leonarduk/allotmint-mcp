...
/**
 * Shared tool specification for the {@code echo} tool, registered against both the HTTP and stdio
 * MCP transports so they expose identical behavior.
 */
final class EchoTool {
  ...
  static McpServerFeatures.SyncToolSpecification specification() {
    ...
    McpSchema.Tool tool =
        McpSchema.Tool.builder("echo", inputSchema)
