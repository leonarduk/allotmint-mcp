...
class StdioMcpServerConfigTest {
    ...
    /**
     * Asserts on bean *definition* presence via the raw bean factory rather than
     * {@code context.getBean(...)}, since actually instantiating this bean attaches a
     * real reader to System.in (see {@link StdioMcpServerConfig}'s class javadoc).
     */
    @Test
